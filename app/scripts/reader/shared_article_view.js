define(['marionette', 
    ...
    'mustache', 
    'jquery', 
    'text!templates/shared_article.html', 
    'scripts/reader/post_model', 
    'text!templates/error.html', 
    'text!templates/not_found.html', 
    'scripts/common/share_view', 
    'scripts/reader/image_contextual_tool_view', 
    'scripts/reader/subscribe_view', 
    'scripts/reader/related_cell_view', 
        ...
        return ArticleView.extend({
            ...
            processImageToGrid: function() {
                ...
                while (startImg.size() > 0) {
                    ...
                    if (imgGroup.size() > 1)  {
                        processImageGroup(imgGroup);
                    } else if (imgGroup.size() > 0 ){
                        processSingleImage(imgGroup.first());
                    }
                }
