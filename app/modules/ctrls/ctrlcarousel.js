...
var Carousel = function(element) {
    ...
    var pane_width = 0;
    var pane_height = Math.round($(window).width() / 4 * 3);
    ...
    function setIndicatorOffset(percent, animate) {
        ...
        var px = Math.round(pane_width * percent / 100);
        var transformStr = 'translate3d(' + px + 'px,0,0)';
    ...
    function setContainerOffset(percent, animate) {
        ...
        var px = Math.round((pane_width * actual_pane_count) * percent / 100);
